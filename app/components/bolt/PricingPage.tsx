...
const plans: Plan[] = [
  {
    ...
    features: [
      'Unlimited Members & History', // Added Value
      'XP & Leveling System',
      'Daily Streaks', // Added Value
      'Badges & Milestones',
      'Leaderboards',
      'Manual Action Tracking',
      // REMOVED: Analytics & Discord
    ],
  },
  {
    name: 'Pro', 
    ...
    features: [
      ...
      'Community Analytics Dashboard', // Moved from Core
      'Quests System',
      'Seasonal Leaderboards', // New Feature
      'Discord Role Sync (Coming Soon)', // Renamed from "Whop Integration"
    ],
    highlight: true,
  },
  {
    ...
    features: [
      ...
      'White-label Branding', // New Feature
    ],
  },
];
  ...
  return (
    <div className={`bg-slate-800 rounded-2xl p-8 border ${plan.highlight ? 'border-purple-500' : 'border-slate-700'} flex flex-col`}>
      ...
      {plan.highlight ? (
        ...
        // Invisible Spacer to keep headings aligned with the "Most Popular" badge
      ...
      <a 
        ...
        className={`block w-full text-center py-3 rounded-lg font-bold transition-colors ${plan.highlight ? 'bg-purple-600 hover:bg-purple-700 text-white' : 'bg-slate-700 hover:bg-slate-600 text-white'}`}
      >
        Choose {plan.name}
      </a>
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="mt-4 text-lg text-slate-400 max-w-2xl mx-auto">
         ...
         <Link href="/admin" className="text-purple-400 hover:text-purple-300 font-semibold mt-2 inline-block">
