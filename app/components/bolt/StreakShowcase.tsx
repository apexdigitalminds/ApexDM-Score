...
const ShowcaseItem: React.FC<{ iconClass?: string, iconFill?: string, label: string, days: string }> = ({ iconClass = '', iconFill = 'currentColor', label, days }) => (
  <div className="flex flex-col items-center text-center">
    <div className={`w-16 h-16 flex items-center justify-center rounded-full bg-slate-100 dark:bg-slate-700/50 mb-2`}>
...
const StreakShowcase: React.FC = () => {
  return (
    <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700">
      <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-4 text-center">Streak Tiers</h3>
