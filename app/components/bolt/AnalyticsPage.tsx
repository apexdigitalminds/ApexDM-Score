        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400">Insights into your community's engagement and growth.</p>
                </div>
            ...
            {isLoading ? (
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                        <div className="lg:col-span-3 bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700">
                            <TopXpActionsChart data={data.topXpActions} />
                        </div>
                        <div className="lg:col-span-2 bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text-lg font-bold text-slate-900 dark:text-white">Activity Breakdown</h3>
                            </div>
                        ...
                        <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-lg flex flex-col border border-slate-200 dark:border-slate-700">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text-lg font-bold text-slate-900 dark:text-white">Streak Health</h3>
                            </div>
                            <div className="space-y-6 flex flex-col justify-center flex-grow">
                                <div className="text-center">
                                    ...
                                    <p className="text-slate-600 dark:text-slate-300">of users that have an active streak</p>
                                </div>
                                <div className="text-center">
                                    ...
                                    <p className="text-slate-600 dark:text-slate-300">is the average streak length</p>
                                </div>
                            </div>
                        </div>
                    </div>
