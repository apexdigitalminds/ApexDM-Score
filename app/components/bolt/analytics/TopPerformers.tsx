...
import type { Profile } from '@/types'; // FIX: Import canonical 'Profile' type from '@/'
...
interface UserPerformanceChartProps {
    ...
    users: Profile[]; // FIX: Use Profile type
    metricLabel: string;
    valueAccessor: (user: Profile) => number; // FIX: Use Profile type
}
...
interface TopPerformersProps {
    usersByXp: Profile[]; // FIX: Use Profile type
    usersByStreak: Profile[]; // FIX: Use Profile type
}
