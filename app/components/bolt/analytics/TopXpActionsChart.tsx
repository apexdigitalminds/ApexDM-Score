    ...
    return (
        <div>
            <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-slate-900 dark:text-white">Top XP-Generating Actions</h3>
            </div>
            <div className="space-y-3">
                {data.map(item => (
                    <div key={item.actionType} className="grid grid-cols-4 items-center gap-4 text-sm">
                        <div className="col-span-1 text-slate-600 dark:text-slate-300 truncate">{item.actionType}</div>
                        <div className="col-span-3 flex items-center gap-2">
                            ...
                            <div className="font-bold text-slate-900 dark:text-white w-16 text-right">{item.totalXp.toLocaleString()} XP</div>
                        </div>
                    </div>
                ))}
            </div>
