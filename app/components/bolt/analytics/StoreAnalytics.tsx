    ...
    return (
        <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-lg h-full border border-slate-200 dark:border-slate-700">
            <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-slate-900 dark:text-white">XP Store Analytics</h3>
            </div>
            <div className="space-y-4">
                <div className="text-center bg-slate-50 dark:bg-slate-700/50 p-4 rounded-lg">
                ...
                <div>
                    <h4 className="text-sm font-semibold text-slate-600 dark:text-slate-300 mb-2">Items Purchased</h4>
                    <div className="space-y-2">
                        {data.items.map(item => (
                            <div key={item.name} className="flex justify-between items-center text-sm p-3 bg-slate-50 dark:bg-slate-700/50 rounded-md">
