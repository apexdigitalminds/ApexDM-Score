    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="text-slate-500 dark:text-slate-400">Discover all the badges you can earn and how to gain XP.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-lg font-bold text-slate-900 dark:text-white">How to Earn XP</h3>
                    </div>
                    ...
                    <div className="space-y-2 max-h-96 overflow-y-auto pr-2 text-sm">
                        {Object.entries(rewardsConfig).map(([action, config]) => (
                            <div key={action} className="flex justify-between items-center p-3 bg-slate-100 dark:bg-slate-700/50 rounded-md">
                                <span className="text-slate-600 dark:text-slate-300 capitalize">{action.replace(/_/g, ' ')}</span>
