 ...
 * Receives `companyId` as a prop from the page file.
 */
export default function AdminDashboard({ companyId }: { companyId: string }) {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-100">
      <div className="container mx-auto p-4 sm:p-6 lg:p-8">
        {showTrialBanner && (
          <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white p-4 rounded-lg mb-6 flex items-center justify-between">
            <div>
              ...
              <p className="text-sm">
                Your trial ends on {trialDate}. Upgrade to continue using all features!
              </p>
            </div>
        ...
        {/* Engagement and Subscription Sections */}
