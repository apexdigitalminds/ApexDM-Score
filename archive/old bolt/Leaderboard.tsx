...
import Link from 'next/link'; // FIX: Use default import for next/link
import type { Profile } from '@/types'; // FIX: Use canonical Profile type
import Avatar from './Avatar';

interface LeaderboardProps {
  users: Profile[]; // Use Profile type
        ...
        {users.map((user, index) => (
          ...
          >
            <div className="flex items-center gap-4">
              ...
              {/* avatarUrl is optional, but we assume Avatar component handles undefined */}
