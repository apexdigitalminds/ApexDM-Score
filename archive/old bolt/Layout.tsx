...
import { NavLink, useRouter } from 'next/navigation';
                    ...
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center gap-2">
                            {selectedUser ? (
                                ...
                                <>
                                    <Link href="/login" className={`${navLinkClasses} ${inactiveClass}`}>
                                        Sign In
                                    </Link>
                                    <Link href="/signup" className="bg-purple-600 text-white font-semibold px-4 py-2 rounded-lg hover:bg-purple-700 transition-colors">
                                        Sign Up
                                    </Link>
                                </>
                            )}
